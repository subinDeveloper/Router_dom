...
const About = () => {
  return (
    ...
    <Layout>
        <article className=" px-6 py-24 mx-auto space-y-12 bg-gradient-to-r from-cyan-500 to-blue-500 dark:bg-gray-100 dark:text-gray-900">
	<div className="w-full mx-auto space-y-4 text-center">
		<p className="text-xs font-semibold tracking-wider uppercase">Router-dom</p>
		<h1 className="text-4xl font-bold leading-tight md:text-5xl">What is React-router-dom?</h1>
	...
	<div className="pt-12 border-t dark:border-gray-300">
		<div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
			...
			<div className="flex flex-col">
				<h4 className="text-lg font-semibold">Dom in react</h4>
				<p className="dark:text-gray-600">React JS Virtual DOM is an in-memory representation of the DOM. DOM refers to the Document Object Model that represents the content of XML or HTML documents as a tree structure so that the programs can be read, accessed and changed in the document structure, style, and content. Table of Content. Prerequisites.</p>
			</div>
		</div>
